      ...
      <div className="grid grid-cols-12 gap-4 xs:gap-6  md:gap-8 w-full">
        ...
        >
          <h2 className="  text-xl md:text-2xl text-left w-full capitalize">
            Welcome to the Tech Galaxy
          </h2>
          <p className="font-light  text-xs sm:text-sm md:text-base   ">
            This is the Tech Galaxy, a place where you can explore the latest advancements in technology and software development. Dive deep into various programming languages, frameworks, and tools that shape our digital world.
          </p>
        </ItemLayout>
        ...
        >
          <p className="font-semibold w-full text-left text-2xl sm:text-5xl">
            100+ <sub className="font-semibold text-base">technologies</sub>
          </p>
        </ItemLayout>
