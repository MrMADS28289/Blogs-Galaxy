      ...
      <div className="grid grid-cols-12 gap-4 xs:gap-6  md:gap-8 w-full">
        ...
        >
          ...
          <p className="font-light  text-xs sm:text-sm md:text-base   ">
            This is the Creative Corner, a space for artistic expression and innovative ideas. Discover various forms of creativity, from digital art to traditional crafts, and get inspired.
          </p>
        </ItemLayout>
        ...
        >
          <p className="font-semibold w-full text-left text-2xl sm:text-5xl">
            100+ <sub className="font-semibold text-base">artworks</sub>
          </p>
        </ItemLayout>
        ...
        >
          <p className="font-semibold w-full text-left text-2xl sm:text-5xl">
            50+{" "}
            <sub className="font-semibold text-base">inspirations</sub>
          </p>
        </ItemLayout>
